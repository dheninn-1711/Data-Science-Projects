...
with open("C:\\Users\\dheni\\Downloads\\Projects\\Stock Market Analysis\\lstm_model.pkl", 'rb') as f:
    model_lstm = pickle.load(f)

with open("C:\\Users\\dheni\\Downloads\\Projects\\Stock Market Analysis\\scaler.pkl", 'rb') as f:
...
with st.sidebar:
    ...
    <p style="color:black";> <b> Designed and Developed by </b> </br> <i> Dheninn Chowdari </i> </p>
    </div>"""
